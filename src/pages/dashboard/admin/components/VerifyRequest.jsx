  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="flex-1 p-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Review and approve relocation request
            </p>
          </div>
          <button
            onClick={() => navigate("/admin/relocation-requests")}
        ...
        {message && (
          <div
            className={`mb-6 p-4 rounded-lg ${message.includes("success") ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
          >
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Postcode: {request.current_postcode}
                </p>
              </div>
              <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="mt-2 text-xs text-gray-500">
                A tax collector must be assigned to verify the new business
                location.
              </p>
            </div>
          ...
          {request.status !== "pending" && (
            <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
              <p className="text-sm font-medium text-gray-700">
                ...
                <span
                  className={`uppercase font-bold ${request.status === "approved" || request.status === "completed" ? "text-green-600" : "text-red-600"}`}
                >
                  {request.status}
                </span>
                .
