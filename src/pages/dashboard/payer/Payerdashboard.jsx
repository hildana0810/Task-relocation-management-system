...
function Payerdashboard() {
  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      message: "Your relocation request has been assigned to Tax Collector.",
      time: "2 hours ago",
      read: false,
    },
    {
      id: 2,
      message: "Field visit scheduled for 12 March.",
      time: "1 day ago",
      read: false,
    },
    {
      id: 3,
      message: "Your relocation request has been approved.",
      time: "3 days ago",
      read: true,
    },
  ]);
                            ...
                            {request.tax_collector ? (
                              <div>
                                <p className="font-medium text-gray-900">
                                  {request.tax_collector.name}
                                </p>
                                <p className="text-xs text-gray-500">
                                  {request.tax_collector.location}
                                </p>
                              </div>
                            ) : (
                        ...
                        >
                          <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm mt-1">
                              Submit your first relocation request to get
                              started
                            </p>
                          </div>
                        </td>
            ...
            {selectedRequest && (
              <div className="mt-8 bg-white rounded-lg shadow p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">
                  Request Tracking - {selectedRequest.id}
                </h3>
                <div className="mb-4">
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">
                        {userData.phoneNumber || "+254 712 345 678"}
                      </p>
                      <p className="text-gray-900">
                        {userData.email || "john@enterprises.com"}
                      </p>
                    </div>
              ...
              <div className="p-6">
                {requests.filter((r) => r.tax_collector).length > 0 ? (
                  <div className="space-y-4">
                      ...
                      .map((request) => (
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span
                              className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getStatusBadge(request.status)}`}
                            >
                              {request.status.charAt(0).toUpperCase() +
                                request.status.slice(1)}
                            </span>
                    ...
                    {requests.filter((r) => r.tax_collector).length > 3 && (
                      <p className="text-xs text-gray-500 text-center pt-2">
                        And {requests.filter((r) => r.tax_collector).length - 3}{" "}
                        more...
                      </p>
                    )}
                  </div>
                  ...
                  <div className="text-center py-4">
                    ...
                    <p className="text-sm text-gray-500">
                      No tax collectors assigned yet
                    </p>
                    <p className="text-xs text-gray-400 mt-1">
                      Tax collectors will be assigned when your request is
                      approved
                    </p>
                  </div>
                )}
                ...
                {userLoading ? (
                  ...
                  <>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span
                        className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getComplianceBadge(userData.complianceStatus)}`}
                      >
