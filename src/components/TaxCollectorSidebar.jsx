      ...
      <div className="p-6">
        ...
        <nav className="space-y-2">
          <Link
            ...
            className={`block px-4 py-3 rounded-lg transition-colors ${isActive('/tax-collector-dashboard')
          ...
          <Link
            ...
            className={`block px-4 py-3 rounded-lg transition-colors ${isActive('/tax-collector-dashboard/taxpayers')
                ? 'bg-blue-600 text-white'
                : 'text-gray-300 hover:bg-gray-700 hover:text-white'
              }`}
          >
          ...
          <Link
            ...
            className={`block px-4 py-3 rounded-lg transition-colors ${isActive('/tax-collector-dashboard/notifications')
                ? 'bg-blue-600 text-white'
                : 'text-gray-300 hover:bg-gray-700 hover:text-white'
              }`}
          >
